      ...
      <div className="max-w-7xl mx-auto space-y-6 print:hidden">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-slate-400 text-sm">Monitora il volume di stampe, esporta i resoconti per i clienti e verifica i pagamenti</p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4 w-full md:w-auto">
            <div className="bg-slate-900 border border-slate-800 p-2.5 sm:px-4 sm:py-2.5 rounded-xl text-center md:text-left">
              <span className="text-[10px] sm:text-[11px] text-slate-400 flex items-center justify-center md:justify-start gap-1 truncate">
                <Wallet className="w-3 h-3 text-slate-400 flex-shrink-0" /> Incassato
              </span>
              <span className="text-sm sm:text-lg font-bold text-white">€{overallStats.totalRevenue.toFixed(2)}</span>
            </div>
            <div className="bg-slate-900 border border-slate-800 p-2.5 sm:px-4 sm:py-2.5 rounded-xl text-center md:text-left">
              <span className="text-[10px] sm:text-[11px] text-slate-400 flex items-center justify-center md:justify-start gap-1 truncate">
                <TrendingUp className="w-3 h-3 text-emerald-400 flex-shrink-0" /> Netto
              </span>
              <span className="text-sm sm:text-lg font-bold text-emerald-400">€{overallStats.totalProfit.toFixed(2)}</span>
            </div>
            <div className="bg-slate-900 border border-slate-800 p-2.5 sm:px-4 sm:py-2.5 rounded-xl text-center md:text-left">
              <span className="text-[10px] sm:text-[11px] text-slate-400 flex items-center justify-center md:justify-start gap-1 truncate">
                <AlertCircle className="w-3 h-3 text-amber-400 flex-shrink-0" /> Sospeso
              </span>
              <span className="text-sm sm:text-lg font-bold text-amber-400">€{overallStats.totalPending.toFixed(2)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className={`lg:col-span-5 space-y-4 ${mobileTab === 'detail' ? 'hidden lg:block' : 'block'}`}>
